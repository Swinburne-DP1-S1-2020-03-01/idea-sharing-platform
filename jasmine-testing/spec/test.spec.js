...
describe('Check Email Details', function(){

	var TestLogin = require('./scripts/login');
	var testLogin;
	...
	it('should check if the email is empty', function(){
		var email = "";
		var testResult = testLogin.checkEmail(email);
